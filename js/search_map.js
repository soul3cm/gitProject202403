        ...
        $(function () {
            ...
            axios.get('js/CityCountyData.json')
                ...
                $("#areaName").on('click', ".areaName_td", function () {
                    ...
                    $.ajax({
                        type: "post",
                        url: "https://3cmproject.000webhostapp.com/project1/search/search-Read-api.php",
                        async: false,
                        data: JSON.stringify(dataJSON),
                        dataType: "json",
                        success: showdata_town_post,
                        error: function () {
                            alert("error-search-Read-api.php");
                        }
                    });
                ...
                $("#postCard").on("click","#vote_btn_O" , function() {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "https://3cmproject.000webhostapp.com/project1/search/search-Create-rea-api.php",
                        data: JSON.stringify(dataJSON),
                        dataType: "json",
                        success:Creaction_showdata,
                        error:function(){
                            alert("error-search-Create-rea-api.php")
                        }
                    });
        ...
        function showdata_town_post(data){
            ...
            var per_postID;
                collect_postID.forEach(function(item){
                    ...
                    $.ajax({
                        type: "post",
                        url: "https://3cmproject.000webhostapp.com/project1/search/search-count-reaction-api.php",
                        async: false,
                        data: JSON.stringify(dataJSON),
                        dataType: "json",
                        success: showdata_count_reaction,
                        error: function () {
                            alert("error-search-count-reaction-api.php");
                        }
                    });
                });
